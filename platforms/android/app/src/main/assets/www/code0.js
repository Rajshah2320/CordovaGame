...
gdjs.menuCode.mapOfGDgdjs_46menuCode_46GDbuttonObjects1Objects = Hashtable.newFrom({"button": gdjs.menuCode.GDbuttonObjects1});gdjs.menuCode.mapOfGDgdjs_46menuCode_46GDbuttonObjects1Objects = Hashtable.newFrom({"button": gdjs.menuCode.GDbuttonObjects1});gdjs.menuCode.mapOfGDgdjs_46menuCode_46GDbuttonObjects1Objects = Hashtable.newFrom({"button": gdjs.menuCode.GDbuttonObjects1});gdjs.menuCode.eventsList0x72d66c = function(runtimeScene) {
...
}; //End of gdjs.menuCode.eventsList0x72d66c
...
gdjs.menuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8317292);
}
}}
...
{
{gdjs.menuCode.conditionTrue_1 = gdjs.menuCode.condition1IsTrue_0;
gdjs.menuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8317812);
}
}}
if (gdjs.menuCode.condition1IsTrue_0.val) {
/* Reuse gdjs.menuCode.GDbuttonObjects1 */
...
{ //Subevents
gdjs.menuCode.eventsList0x72d66c(runtimeScene);} //End of subevents
}
